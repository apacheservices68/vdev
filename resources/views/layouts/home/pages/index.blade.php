                        ...
                        <div class="news-wrapper col-md-8 col-sm-7">                         
                            <article class="news-item page-row has-divider clearfix row">       
                                <figure class="thumb col-md-2 col-sm-3 col-xs-4">
                                    <img class="img-responsive" src="template/assets/images/news/news-thumb-1.jpg" alt="" />
                                </figure>
                            ...
                            <article class="news-item page-row has-divider clearfix row">       
                                <figure class="thumb col-md-2 col-sm-3 col-xs-4">
                                    <img class="img-responsive" src="template/assets/images/news/news-thumb-2.jpg" alt="" />
                                </figure>
                                <div class="details col-md-10 col-sm-9 col-xs-8">
                            ...
                            <article class="news-item page-row has-divider clearfix row">       
                                <figure class="thumb col-md-2 col-sm-3 col-xs-4">
                                    <img class="img-responsive" src="template/assets/images/news/news-thumb-3.jpg" alt="" />
                                </figure>
                                <div class="details col-md-10 col-sm-9 col-xs-8">
                            ...
                            <article class="news-item page-row has-divider clearfix row">       
                                <figure class="thumb col-md-2 col-sm-3 col-xs-4">
                                    <img class="img-responsive" src="template/assets/images/news/news-thumb-4.jpg" alt="" />
                                </figure>
                                <div class="details col-md-10 col-sm-9 col-xs-8">
                            ...
                            <article class="news-item page-row has-divider clearfix row">       
                                <figure class="thumb col-md-2 col-sm-3 col-xs-4">
                                    <img class="img-responsive" src="template/assets/images/news/news-thumb-5.jpg" alt="" />
                                </figure>
                                <div class="details col-md-10 col-sm-9 col-xs-8">
                            ...
                            <article class="news-item page-row has-divider clearfix row">       
                                <figure class="thumb col-md-2 col-sm-3 col-xs-4">
                                    <img class="img-responsive" src="template/assets/images/news/news-thumb-6.jpg" alt="" />
                                </figure>
                                <div class="details col-md-10 col-sm-9 col-xs-8">
