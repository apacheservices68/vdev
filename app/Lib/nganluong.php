...
class Nl_checkout 
{
	...
	private $merchant_site_code = '39969'; //100001 chỉ là ví dụ, bạn hãy thay bằng mã của bạn

	// Mật khẩu giao tiếp giữa website của bạn và NgânLượng.vn.
	private $secure_pass= '0bf8e3d73ca70374'; //d685739bf1 chỉ là ví dụ, bạn hãy thay bằng mật khẩu của bạn
